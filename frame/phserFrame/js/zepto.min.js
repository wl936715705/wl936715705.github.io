...
;(function($){
    ['tap','mySwipeUp', 'mySwipeDown', 'mySwipeLeft', 'mySwipeRight'].forEach(function (eventName) {
        $.fn[eventName] = function(callback){
            ...
            $(this).on('touchend', function (e) {
                ...
                if(startY-endY>=50){
                    $(this).trigger('mySwipeUp');//向上滑
                }else if(endY-startY>=50){
                    $(this).trigger('mySwipeDown');//向下滑
                }else if(startX-endX>=50){
                    $(this).trigger('mySwipeLeft');//向左滑
                }else if(endX-startX>=50){
                    $(this).trigger('mySwipeRight');//向右滑
                }
